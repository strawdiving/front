...
// modified from python config from codemirror
...
(function (mod) {
  ...
  var commonKeywords = ["break",
    "def", "elif", "else", "end",
    "global", "if", "return", "while"
  ];
  var commonBuiltins = ["Array", "movej", "movej_pose", "movel", "movec",
  ...
  CodeMirror.registerHelper("hintWords", "robot", commonKeywords.concat(commonBuiltins));

  function top(state) {
    return state.scopes[state.scopes.length - 1];
  }

  CodeMirror.defineMode("robot", function (conf, parserConf) {
    ...
    myKeywords = myKeywords.concat(["False", "True"]);
